...
function transformRSSHotspots(hotspots: GlobalHotspot[]): GeoHotNews[] {
  ...
  // 坐标格式统一为 [lng, lat]（与 CITY_COORDS 和 D3 geoProjection 一致）
  const coordMap: Record<string, [number, number]> = {
    // 中国大陆
    '北京': [116.40, 39.90], 'Beijing': [116.40, 39.90], '北京,': [116.40, 39.90],
    '上海': [121.47, 31.23], 'Shanghai': [121.47, 31.23],
    '深圳': [114.07, 22.62], 'Shenzhen': [114.07, 22.62],
    '杭州': [120.15, 30.28], 'Hangzhou': [120.15, 30.28],
    '广州': [113.26, 23.13], 'Guangzhou': [113.26, 23.13],
    '成都': [104.07, 30.67], 'Chengdu': [104.07, 30.67],
    '合肥': [117.23, 31.82], 'Hefei': [117.23, 31.82],
    '武汉': [114.30, 30.60], 'Wuhan': [114.30, 30.60],
    '南京': [118.78, 32.06], 'Nanjing': [118.78, 32.06],
    '西安': [108.94, 34.26], 'Xi\'an': [108.94, 34.26],
    '重庆': [106.55, 29.57], 'Chongqing': [106.55, 29.57],
    '苏州': [120.59, 31.30], 'Suzhou': [120.59, 31.30],
    '无锡': [120.30, 31.57], 'Wuxi': [120.30, 31.57],
    // 中国台湾
    '台北': [121.57, 25.03], 'Taipei': [121.57, 25.03],
    '新竹': [120.97, 24.80], 'Hsinchu': [120.97, 24.80],
    // 美国
    '硅谷': [-122.08, 37.39], 'Silicon Valley': [-122.08, 37.39], 'Santa Clara': [-121.96, 37.35],
    '旧金山': [-122.42, 37.77], 'San Francisco': [-122.42, 37.77],
    '华盛顿': [-77.04, 38.91], 'Washington': [-77.04, 38.91], 'D.C.': [-77.04, 38.91],
    '纽约': [-74.01, 40.71], 'New York': [-74.01, 40.71],
    '奥斯汀': [-97.74, 30.27], 'Austin': [-97.74, 30.27],
    '西雅图': [-122.33, 47.61], 'Seattle': [-122.33, 47.61],
    '波士顿': [-71.06, 42.36], 'Boston': [-71.06, 42.36],
    '洛杉矶': [-118.24, 34.05], 'Los Angeles': [-118.24, 34.05],
    '圣地亚哥': [-117.16, 32.72], 'San Diego': [-117.16, 32.72],
    '达拉斯': [-96.80, 32.78], 'Dallas': [-96.80, 32.78],
    '芝加哥': [-87.63, 41.88], 'Chicago': [-87.63, 41.88],
    '凤凰城': [-112.07, 33.45], 'Phoenix': [-112.07, 33.45],
    '山景城': [-122.08, 37.39], 'Mountain View': [-122.08, 37.39],
    // 日本
    '东京': [139.69, 35.69], 'Tokyo': [139.69, 35.69],
    '大阪': [135.50, 34.69], 'Osaka': [135.50, 34.69],
    '名古屋': [136.91, 35.18], 'Nagoya': [136.91, 35.18],
    '横滨': [139.64, 35.44], 'Yokohama': [139.64, 35.44],
    // 韩国
    '首尔': [126.98, 37.57], 'Seoul': [126.98, 37.57],
    '平泽': [127.08, 36.99], 'Pyeongtaek': [127.08, 36.99],
    // 欧洲
    '巴黎': [2.35, 48.86], 'Paris': [2.35, 48.86],
    '伦敦': [-0.13, 51.51], 'London': [-0.13, 51.51],
    '柏林': [13.40, 52.52], 'Berlin': [13.40, 52.52],
    '慕尼黑': [11.58, 48.14], 'Munich': [11.58, 48.14],
    '阿姆斯特丹': [4.90, 52.37], 'Amsterdam': [4.90, 52.37],
    '埃因霍温': [5.47, 51.44], 'Eindhoven': [5.47, 51.44],
    '布鲁塞尔': [4.35, 50.85], 'Brussels': [4.35, 50.85],
    '苏黎世': [8.54, 47.38], 'Zurich': [8.54, 47.38],
    // 东南亚
    '新加坡': [103.82, 1.35], 'Singapore': [103.82, 1.35],
    '曼谷': [100.50, 13.75], 'Bangkok': [100.50, 13.75],
    '吉隆坡': [101.69, 3.14], 'Kuala Lumpur': [101.69, 3.14],
    // 南亚
    '班加罗尔': [77.59, 12.97], 'Bangalore': [77.59, 12.97], 'Bengaluru': [77.59, 12.97],
    '孟买': [72.88, 19.08], 'Mumbai': [72.88, 19.08],
    '新德里': [77.21, 28.61], 'New Delhi': [77.21, 28.61],
    // 中东
    '迪拜': [55.27, 25.20], 'Dubai': [55.27, 25.20],
    '特拉维夫': [34.78, 32.08], 'Tel Aviv': [34.78, 32.08],
    // 其他
    '悉尼': [151.21, -33.87], 'Sydney': [151.21, -33.87],
    '墨尔本': [144.96, -37.81], 'Melbourne': [144.96, -37.81],
    '多伦多': [-79.38, 43.65], 'Toronto': [-79.38, 43.65],
    '渥太华': [-75.70, 45.42], 'Ottawa': [-75.70, 45.42],
    '温哥华': [-123.12, 49.28], 'Vancouver': [-123.12, 49.28],
  }
  ...
  for (const h of hotspots.slice(0, 20)) {  // P1修复：从8→20再过滤，确保产出充足
    ...
    const searchText = (h.title + ' ' + (h.summary || '')).toLowerCase()
    ...
    if (city === '全球' && regionToCity[h.region]) {
      ...
      if (coordMap[fallbackCity]) {
        city = fallbackCity
        lat = coordMap[fallbackCity][1]
        lng = coordMap[fallbackCity][0]
      }
    }
